            ...
            <div class="navbar-main">
              ...
              <div class="container" style="margin-right: 10px;">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.html"><img src="Orphanation.jpg" style="margin-left:-260px; height: 42px; width:450px;" ></a>
                  
                </div>

                <!-- <img src="Orphanation.jpg"> -->
      ...
      <div class="container-fliud">
        <div class="wrapper row">
          ...
          <div class="details col-md-6" style="padding-left: 1px; width: 500px;">
            <h3 class="product-title" style="color:black; margin-left:-40px;"><b>Name:  <?php echo $row['orphanage_name'];?></b></h3><br>
             <h5 class="sizes" style="color:black; margin-bottom:12px;">ID:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['orphanage_id'];?></h5>
             <h5 class="sizes" style="color:black; margin-bottom:12px;">Owner:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['orphanage_owner'];?></h5>
        ...
        <div class="action"><form id="senddata" method="_GET" action="approve.php">
              <button form="senddata" name="search" id="search" formmethod="_GET" class="add-to-cart btn btn-default" type="submit" style="margin-left: 500px; height: 50px; background-color: #1f76bd;  margin-top: -10px; margin-bottom:200px;">Approve!</button>
            </form>
