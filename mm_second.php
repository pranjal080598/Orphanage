...
<html class="no-js">
                    ...
                    <li><a href="gallery.html">GALLERY</a></li>-->
                     ...
                     <?php 
                      ...
                      ?>
                        ...
                        <li><a href="mm_second.php" class="is-active">TO BE COLLECTED</a></li>
   ...
   <div class="col-md-12 fadeIn ">
            ...
            <table class="table table-style-1">
                <thead>
                  <tr>
                    <th><input type='checkbox'  value='1' name='checkbox' class="selectall" /></th>
                    <th>Order Id</th>
                    <th>User Id</th>
                    <th>Item ID</th>
                    <th>Photo</th>
              ...
              $conn = new mysqli("127.0.0.1:3306","root","root@123","orphanation");
                 $sql="select * from orphanation.orders where mm_id1 ='$login_session_id' and mm_id2 IS NULL";
                 ...
                 if($result->num_rows>0) 
                 {
                      ...
                      while($row=$result->fetch_assoc())
                      {
                              ...
                              <input type='checkbox'  value='1' name='checkbox[]' class='justone' /></th>
                                <td>".$row["order_id"]."</td>
                                <td>".$row["user_id"]."</td>
                                <td>".$row["item_id"]."</td>
                                <td>".$row["photo"]."</td>
