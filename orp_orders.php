                     ...
                     <?php 
                      ...
                      ?>
                        ...
                        <li><a href="cartview.php">CART</a></li>
                         <li><a href="orp_orders.php" class="is-active">ORDER</a></li>
                        <li><a href="contact.php">CONTACT</a></li>
            ...
            <table class="table table-style-1" id="mytable">
                ...
                <tbody>
                    ...
                    <?php
                      ...
                      { 
                        $sql="select * from orphanation.orders where mm_id2 IS NOT NULL and orphanage_id='$login_session_id'";
                        $result = $conn ->query($sql);
                          if($result->num_rows>0)
                          {
                            ...
                            while ($row=$result->fetch_assoc()) {
                              ...
                              $var=$row['order_id'];
                              echo "<tr><th scope='row'>".$no."</th><td><a href='orphan_info.php?id=".$var."'>".$var."</td></a><td>".$row1["user_name"]."</td><td>".$row2["item_name"]."</td><td>".$row["order_date"]."</td><td>".$row4["mm_name"]."</td><td>".$row5["mm_name"]."</td>";
                              echo "</tr>";
                              $no=$no+1;
                            }
                          }
